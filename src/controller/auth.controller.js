...
class AuthController {
    ...
    async register(req, res) {
        try {
            ...
            if (username.length <= 0 || password.length <= 0) return response.ErrorResponse(res, "not null field")
            ...
            if (user.length > 0) return response.ErrorResponse(res, "Tai khoan da ton tai!");
